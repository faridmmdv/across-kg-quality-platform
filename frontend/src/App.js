  ...
  const handleLogin = (e) => {
    ...
    if (loginType === 'admin') {
      if (email === 'admin@across.eu' && password === 'admin123') {
        setUser({ role: 'admin', name: 'Sandra Schaftner', title: 'Federation Quality Lead' });
      } else {
        alert("ACCESS DENIED: Required: admin@across.eu / admin123");
      }
    } else {
      if (email === 'staff@tu-chemnitz.de' && password === 'staff123') {
        setUser({ role: 'uni', name: 'TU Chemnitz Staff', title: 'Data Officer' });
      } else {
    ...
    return (
      <div className="login-container">
        <div className="login-hero">
          ...
          <p className="hero-text">Advanced Quality Management Platform grounded in <strong>FAIR Principles</strong> and <strong>Linked Data Standards</strong>.</p>
          <div className="hero-features">
            <div className="feature-pill">🛡️ SHACL Validation</div>
            <div className="feature-pill">🔗 Entity Alignment</div>
          </div>
        </div>
